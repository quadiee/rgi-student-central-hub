...
import { Bell, Search, Menu, User, Settings, RefreshCw } from 'lucide-react';
import { cn } from '../../lib/utils';
import ChairmanMobileSidebar from './ChairmanMobileSidebar';
...
const AdaptiveMobileHeader: React.FC<AdaptiveMobileHeaderProps> = ({ 
  ...
  const isViewOnlyRoute = () => {
    return user?.role === 'chairman' && ['/students', '/faculty', '/fees'].includes(currentRoute);
  };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button
                ...
                size="sm"
                className={cn(
                  "p-2 relative transition-all duration-200 hover:scale-105",
                  isScrolled ? "text-gray-700 hover:bg-gray-100" : "text-white hover:bg-white/20"
                )}
              >
