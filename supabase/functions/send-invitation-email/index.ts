...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const invitationUrl = `${Deno.env.get('SITE_URL') || 'https://c828c58b-ec78-4a9f-a0a8-de7b97d79438.lovableproject.com'}/auth?mode=invited&email=${encodeURIComponent(email)}`;
    ...
    // In a real implementation, you would integrate with a mail service like Resend
